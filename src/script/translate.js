...
const translations = {
  es: {
    ...
    "destinos.subtitle":
      "Explora los lugares más increíbles del Mundo con nuestras experiencias cuidadosamente diseñadas",
    ...
    "compra.section3":
      "¿Algún pasajero tiene alergias o intolerancias alimentarias?",
    ...
    // Comunidad page
    "comunidad.titulo": "Comunidad Mochilera",
    "comunidad.subtitulo":
      "Comparte tus experiencias y descubre las aventuras de otros viajeros",
    "comunidad.login-required":
      'Debes <a href="login.html">iniciar sesión</a> para publicar comentarios y dar likes.',
    "comunidad.btn-publicar": "Publicar",
    "comunidad.comentarios-titulo": "Experiencias de viajeros",
    "comunidad.orden": "Ordenados por popularidad",
    "comunidad.sin-comentarios":
    ...
    "soporte.a1":
      "Las cancelaciones realizadas con más de 15 días de antelación tienen reembolso del 100%. Entre 7-15 días: reembolso del 50%. Menos de 7 días: no hay reembolso. Las cancelaciones por causa de fuerza mayor se evalúan caso por caso. Te recomendamos contratar seguro de cancelación.",
    "soporte.q2": "¿Cómo puedo modificar mi reserva?",
    "soporte.a2":
      'Puedes modificar tu reserva hasta 48 horas antes de la fecha de salida sin coste adicional. Accede a "Mi cuenta" > "Mis reservas" y selecciona la opción "Modificar". Los cambios de fecha o destino están sujetos a disponibilidad y posibles diferencias de precio.',
    "soporte.q3": "¿Qué documentación necesito para viajar?",
    "soporte.a3":
      "Para viajes internacionales necesitas pasaporte con validez mínima de 6 meses. Algunos destinos requieren visado - consulta los requisitos específicos en nuestra sección de destinos. Para viajes nacionales, el DNI es suficiente. Revisa también si necesitas certificados de vacunación según el destino.",
    "soporte.q4": "¿Ofrecéis seguro de viaje?",
    "soporte.a4":
      "Recomendamos encarecidamente contratar un seguro de viaje. Trabajamos con varias aseguradoras que ofrecen cobertura médica, de equipaje y cancelación. Puedes añadirlo durante el proceso de reserva o contratarlo por tu cuenta. El seguro no está incluido en el precio base del viaje.",
  ...
  en: {
    ...
    "home.card3-text":
      "Don't miss this incredible destination in Northern Europe",
    ...
    "home.card7-text":
      "Discover the unique city with the most backpackers in all of Asia",
    ...
    "destinos.subtitle":
      "Explore the world's most incredible places with our carefully designed experiences",
    ...
    "destinos.desc1":
      "White sand beaches and crystal clear waters in Caribbean paradise",
    "destinos.desc2":
      "Catamaran excursion to the most beautiful Caribbean island",
    "destinos.desc3":
      "Discover the history and culture in America's first city",
    ...
    "registro.subtitle":
      "Let's get everything ready for you to create your backpacker account",
    ...
    // Comunidad page
    "comunidad.titulo": "Backpacker Community",
    "comunidad.subtitulo":
      "Share your experiences and discover the adventures of other travelers",
    "comunidad.login-required":
      'You must <a href="login.html">sign in</a> to post comments and give likes.',
    "comunidad.btn-publicar": "Publish",
    "comunidad.comentarios-titulo": "Traveler Experiences",
    "comunidad.orden": "Sorted by popularity",
    "comunidad.sin-comentarios":
    ...
    "soporte.a1":
      "Cancellations made more than 15 days in advance receive a 100% refund. Between 7-15 days: 50% refund. Less than 7 days: no refund. Cancellations due to force majeure are evaluated on a case-by-case basis. We recommend purchasing cancellation insurance.",
    "soporte.q2": "How can I modify my booking?",
    "soporte.a2":
      'You can modify your booking up to 48 hours before the departure date at no additional cost. Access "My Account" > "My Bookings" and select the "Modify" option. Date or destination changes are subject to availability and possible price differences.',
    "soporte.q3": "What documentation do I need to travel?",
    "soporte.a3":
      "For international travel you need a passport with a minimum validity of 6 months. Some destinations require a visa - check the specific requirements in our destinations section. For domestic travel, an ID is sufficient. Also check if you need vaccination certificates depending on the destination.",
    "soporte.q4": "Do you offer travel insurance?",
    "soporte.a4":
      "We strongly recommend purchasing travel insurance. We work with several insurers that offer medical, baggage, and cancellation coverage. You can add it during the booking process or purchase it on your own. Insurance is not included in the base price of the trip.",
